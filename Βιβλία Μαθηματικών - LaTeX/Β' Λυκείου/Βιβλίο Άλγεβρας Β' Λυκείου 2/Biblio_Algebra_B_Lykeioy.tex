...
\font\onoma="Kerkis Sans Bold" at 13pt
...
{\normalfont\Large\bf}%
{}{0em}%
{{\color{black}\titlerule[0pt]}\vskip-.2\baselineskip{\parbox[t]{\dimexpr\textwidth-2\fboxsep\relax}{\raggedright\strut\textit{\LARGE{\thesection~#1}}\strut}}}[\vskip 0\baselineskip{\color{black}\titlerule[1pt]}]
...
\input{Systhmata.tex}
%\input{Idiothtes.tex}
%\input{Trigwnometria.tex}
%\input{Polywnyma.tex}
%\input{Ekthetikh_Logarithmos.tex}
\end{document}