\begin{thema}{Β}
Στο παρακάτω σχήμα δίνεται η γραφική παράσταση της \textbf{{παραγώγου}} $f'$ μιας συνάρτησης $f:[0, 4] \to \mathbb{R}$, η οποία είναι συνεχής στο $[0,4]$ και παραγωγίσιμη στο $(0,4)$.
\begin{center}
\begin{tikzpicture}
