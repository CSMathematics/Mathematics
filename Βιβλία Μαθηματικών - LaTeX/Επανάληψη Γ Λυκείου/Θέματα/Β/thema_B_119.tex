...
\begin{tikzpicture}[scale=0.8]
  ...
  \draw[dashed, red!60!black] (-1,1) -- (1.5,3.5);
  \node[red!60!black,font=\footnotesize] at (1.5,3.8) {$\varepsilon_A$};
  % tangent at B(2,0), slope -2
  \draw[dashed, red!60!black] (1,2) -- (3,-2);
  \node[red!60!black,font=\footnotesize] at (3,-1.7) {$\varepsilon_B$};
...
\begin{erwthma}
  \item 
  \item Γράψτε τις εξισώσεις εφαπτομένων $\varepsilon_A$ και $\varepsilon_B$.
  \item 
