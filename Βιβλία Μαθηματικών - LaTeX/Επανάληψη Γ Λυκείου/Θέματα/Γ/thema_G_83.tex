\begin{thema}{Γ}
Στο παρακάτω σχήμα δίνεται η γραφική παράσταση $C_f$ της συνάρτησης $f(x)=x-1+\dfrac{1}{x}$, $x\in\mathbb{R}^*$. Η $C_f$ παρουσιάζει πλάγια ασύμπτωτη $y = x - 1$ στο $+\infty$. Η $f$ έχει τοπικό ελάχιστο στο σημείο $E(1, 1)$.
...
\begin{tikzpicture}[scale=0.7]
  ...
  \draw[very thick, maincolor, domain=-3:-0.18, samples=100] plot (\x, {\x - 1 + 1/\x});
