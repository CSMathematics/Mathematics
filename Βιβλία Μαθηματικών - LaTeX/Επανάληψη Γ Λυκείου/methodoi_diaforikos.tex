...
\begin{mytblr}{rowhead = 2,row{1-2} = {maincolor!70!black,fg={white}},row{2}={font=\bf},cell{1-2}{3-5} = {orange!90!black},cell{even[4-Z]}{3-5} = {orange!70!white},cell{odd[3-Z]}{3-5} = {orange!30!white}}
...
\begin{itemize}
    ...
    \\
\wrapr{-5mm}{10}{6.2cm}{-15mm}{\begin{tikzpicture}[scale=0.7]
    \begin{axis}[
        axis lines = middle,
        xlabel = $x$,
        ylabel = $y$,
