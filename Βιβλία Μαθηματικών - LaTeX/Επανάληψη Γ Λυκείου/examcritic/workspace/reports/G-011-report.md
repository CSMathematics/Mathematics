...
- Topic source: `Θέματα/Γ/thema_G_11.tex`
- Solution source: `Λύσεις θεμάτων/Γ/solution_G_11.tex`
...
- Branches: area_applications, convexity_inflection, derivatives, graph_study, integrals, monotonicity_extrema
- Question types: area_between_curves, convexity_inflection, graph_interpretation, monotonicity_extrema, tangent_line
