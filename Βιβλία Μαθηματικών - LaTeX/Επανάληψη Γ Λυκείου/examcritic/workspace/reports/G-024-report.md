...
- Topic source: `Θέματα/Γ/thema_G_24.tex`
- Solution source: `Λύσεις θεμάτων/Γ/solution_G_24.tex`
...
- Branches: convexity_inflection, derivatives, inequalities, limits_continuity
- Question types: convexity_inflection, derivative_computation, inequality_proof, limit_evaluation, tangent_line
