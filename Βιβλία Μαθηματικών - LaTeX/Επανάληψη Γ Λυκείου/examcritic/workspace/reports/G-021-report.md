...
- Topic source: `Θέματα/Γ/thema_G_21.tex`
- Solution source: `Λύσεις θεμάτων/Γ/solution_G_21.tex`
...
- Branches: integrals
- Question types: integral_calculation
- Rare question types: Δεν έχει συμπληρωθεί
- Monothematicity score: 0

## Difficulty And Time

- Raw difficulty: 5.58
- Technical complexity: 6.8
- Conceptual depth: 4.6
- Solution steps: 7.2
- Originality: 3.5
- Estimated time: 25
...
- Αυτόματη αναγνώριση 1 τύπων ερωτημάτων.
- Αυτόματη αναγνώριση 1 ενοτήτων/κλάδων ύλης.
