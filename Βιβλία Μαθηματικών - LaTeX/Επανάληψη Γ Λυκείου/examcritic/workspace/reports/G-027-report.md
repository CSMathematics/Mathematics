...
- Topic source: `Θέματα/Γ/thema_G_27.tex`
- Solution source: `Λύσεις θεμάτων/Γ/solution_G_27.tex`
...
- Branches: convexity_inflection, derivatives, limits_continuity, parameter_analysis
- Question types: convexity_inflection, derivative_computation, limit_evaluation, parameter_condition
- Rare question types: parameter_condition
