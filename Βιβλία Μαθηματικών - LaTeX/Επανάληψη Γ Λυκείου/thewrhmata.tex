...
\label{thewrhma:symmetria_antistrofhs}
...
\label{thewrhma:orio_polywnymikhs}
...
\label{thewrhma:endiameswn_timwn}
...
\label{thewrhma:paragwgisimh_synechhs}
...
\label{thewrhma:paragwgos_statherhs}
...
\label{thewrhma:paragwgos_taytotikhs}
...
\label{thewrhma:paragwgos_dynamhs}
...
\label{thewrhma:paragwgos_arrhths}
...
\label{thewrhma:paragwgos_athroismatos}
...
\label{thewrhma:paragwgos_dynamhs_arnhtikos}
...
\label{thewrhma:paragwgos_efaptomenhs}
...
\label{thewrhma:paragwgos_synefaptomenhs}
...
\label{thewrhma:paragwgos_dynamhs_mh_akeraiou}
...
\label{thewrhma:paragwgos_ekthetikhs}
...
\label{thewrhma:paragwgos_logarithmou}
...
\label{thewrhma:synepeies_thmt_1}
...
\label{thewrhma:synepeies_thmt_2}
...
\label{thewrhma:kritirio_monotonias}
...
\label{thewrhma:kritirio_topikwn_akrotatwn}
...
\label{thewrhma:arxikh_synarthsh}
...
\label{thewrhma:themelivdes_oloklhrwtikou}
