...
\begin{tikzpicture}[curveinscope,scale=0.7,every node/.style={scale=0.7}]
\draw[line width=.7mm,gray] (0,0) circle(7);
...
\draw[pl,-latex,white] (5,0.5) arc (5.7106:40:5.0249);
\draw[pl,-latex,white] (5,-0.5) arc (-5.7106:-40:5.0249);
...
\draw[thick,gray] (\a:1) -- (\a:5); 
%30° Rays
\foreach \a in {0, 30,...,359}
\draw[thick,gray] (0, 0) -- (\a:5);
\foreach \r in {1, 2,...,5}
\draw[cyan!80!black, thick] (0,0) circle (\r);    
