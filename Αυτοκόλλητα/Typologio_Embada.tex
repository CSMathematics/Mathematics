...
rowspec={t{7mm}},columns = {c},
  ...
  row{odd} = {bg=purple9,fg=black,ht=8mm},
 row{even} = {bg=purple7,fg=black,ht=8mm},
hlines={white},vlines={white},
row{1} = {bg=purple4, fg=white, font=\Large\bfseries\fontfamily{maksf}},rowhead = 1,
  hline{2} = {.7mm}, % midrule  
}
...
\draw[fill=purple!40] (O) -- (C) -- (G) -- (D) -- cycle;
\draw[fill=purple!20,opacity=0.5] (O) -- (C) -- (G) -- (D) -- cycle;
\draw[fill=purple!20] (O) -- (A) -- (E) -- (D) -- cycle;
\draw[fill=purple!20] (O) -- (A) -- (B) -- (C) -- cycle;
\draw[fill=purple!20,opacity=0.4] (D) -- (E) -- (F) -- (G) -- cycle;
\draw[fill=purple!20,opacity=0.6] (C) -- (B) -- (F) -- (G) -- cycle;
\tkzText(2.2,1){$a$}
\tkzText(0.3,-1){$a$}
\tkzText(1.8,-.5){$a$}
\end{tikzpicture}
...
{\kerkissans{Σφαίρα}\\
\begin{tikzpicture}
  \shade[ball color = purple!30, opacity = 0.4] (0,0) circle (1.8cm);
...
\begin{tikzpicture}
\draw[fill=purple!20] (0,0) ellipse (1.5 and 0.5);
\draw (-1.5,0) -- (-1.5,-2.5);
\draw (-1.5,-2.5) arc (180:360:1.5 and 0.5);
\draw [dashed] (-1.5,-2.5) arc (180:360:1.5 and -0.5);
\draw (1.5,-2.5) -- (1.5,0);  
\shadedraw[left color=purple!50,
  right color=purple!60,
  middle color=purple!20,opacity=0.5,shading angle=90] (-1.5,0) -- (-1.5,-2.5) arc (180:360:1.5 and 0.5) -- (1.5,0) arc (0:180:1.5 and -0.5);
...
\draw[pl,fill=purple!30,opacity=0.4] (A)--(B)--(K) -- cycle;
\draw[pl,fill=purple!20,opacity=0.4] (A)--(B)--(K) -- cycle;
\draw[pl,fill=purple!20,opacity=0.5] (C)--(B)--(K) -- cycle;
\draw[pl,fill=purple!20,opacity=0.5] (C)--(D)--(K) -- cycle;
...
{\kerkissans{Κώνος}\\
\begin{tikzpicture}
\draw[fill=purple!20] (0,-0.2) ellipse (1.5 and 0.5);
\shadedraw[left color=purple!50,
  right color=purple!60,
  middle color=purple!30,opacity=0.5,shading angle=90] (-1.5,0) -- (-0,2.5) -- (1.5,0) arc (180:360:-1.5 and 0.5);
