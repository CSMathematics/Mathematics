...
\item 
$\begin{aligned}[t]
\lim\limits_{x\to 2}{\dfrac{\sqrt{3x-2}-2}{x^2-4}}&\stackrel{\frac{0}{0}}{=}\lim\limits_{x\to 2}{\dfrac{\left(\sqrt{3x-2}-2\right)\left(\sqrt{3x-2}+4\right)}{\left(x^2-4\right)\left(\sqrt{3x-2}+4\right)}}=\\&=\lim\limits_{x\to 2}{\dfrac{3x-2-4}{(x-2)(x+2)\left(\sqrt{3x-2}+4\right)}}=\\&=\lim\limits_{x\to 2}{\dfrac{3(x-2)}{(x-2)(x+2)\left(\sqrt{3x-2}+4\right)}}=\lim\limits_{x\to 2}{\dfrac{3}{(x-2)\left(\sqrt{3x-2}+4\right)}}=\dfrac{3}{32}
\end{aligned}$
\item 
$\begin{aligned}[t]
...
\lysh\vspace{-7mm}
\begin{alist}
\item $\lim\limits_{x\to +\infty}{\dfrac{\ln{x}}{x}}\xlongequal[\text{\eng{DLH}}]{\frac{-\infty}{+\infty}}\lim\limits_{x\to +\infty}{\dfrac{\frac{1}{x}}{1}}=\lim\limits_{x\to+\infty}{\frac{1}{x}}=0$.
