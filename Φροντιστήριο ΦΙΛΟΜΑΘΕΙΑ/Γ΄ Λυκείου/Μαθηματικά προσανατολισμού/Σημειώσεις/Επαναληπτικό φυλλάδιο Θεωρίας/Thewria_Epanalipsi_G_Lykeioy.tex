...
\path[left color=\xrwma,right color=\xrwma!50,draw=black]
...
colback=white,title={\kerkissans{\large Θεώρημα \theThewrhmabox}} : {\textcolor{black}{\kerkissans{#1}}}]}
{\end{tcolorbox}}
%------------------------------------------
...
title style={color=white},
overlay unbroken and first={
\path[left color=orange3,right color=\xrwma!50,draw=black]
([yshift=-\pgflinewidth]frame.north west) to ([yshift=-5pt]title.south west)[rounded corners=2pt] -- ([xshift=-#2-15pt,yshift=-5pt]title.south east) to[rounded corners=2pt] ([xshift=-#2,yshift=-\pgflinewidth]frame.north east) -- cycle;
},
fonttitle=\bfseries,
before=\par\medskip\noindent,
...
\end{Orismosbox}
\begin{Orismosbox}{Ίσες συναρτήσεις με κοινό πεδίο ορισμού}
Δύο συναρτήσεις $ f,g $ που έχουν το ίδιο πεδίο ορισμού $ A $ ονομάζονται ίσες δηλαδή $ f=g $ όταν ισχύει $ f(x)=g(x) $ για κάθε $ x\in A $.\\\\
\end{Orismosbox}
\begin{Orismosbox}{Ίσες συναρτήσεις με διαφορετικά πεδία ορισμού}
...
\end{Orismosbox}
\begin{Orismosbox}{Γνησίως μονότονη συνάρτηση}
...
\end{Orismosbox}
\begin{Orismosbox}{Ολικά ακρότατα}
...
\end{itemize}
\end{Orismosbox}
\begin{Orismosbox}{Συνέχεια συνάρτησης σε σημείο}
...
\end{Orismosbox}
\begin{Orismosbox}{Συνέχεια συνάρτησης σε σύνολο}
\begin{enumerate}
