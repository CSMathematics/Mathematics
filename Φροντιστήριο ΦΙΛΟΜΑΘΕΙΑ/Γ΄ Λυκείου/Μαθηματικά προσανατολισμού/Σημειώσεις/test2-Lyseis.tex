...
%# Στοιχεία αρχείου Alg-Anis1ou-AnisApT-LA1--------
%@ Κωδικός : Alg-Anis1ou-AnisApT-LA1
%@ Ενότητα : Ανισώσεις 1ου βαθμού
%@ Είδος άσκησης : Ανισώσεις με απόλυτες τιμές
%@ Διαδρομή αρχείου : /home/spyros/Μαθηματικά/Βάση Δεδομένων Μαθηματικών/Άλγεβρα/Ενότητες/Ανισώσεις 1ου βαθμού/Λύσεις Ασκήσεων/Ανισώσεις με απόλυτες τιμές/Alg-Anis1ou-AnisApT-LA1.tex
%#--------------------------------------------------



Η άσκηση \en{Alg-Anis1ou-EpilAnis-LA1} δεν είναι λυμένη.


Η άσκηση \en{Alg-Anis1ou-EpilAnis-LA2} δεν είναι λυμένη.


Η άσκηση \en{Alg-Anis1ou-EpilAnis-LA3} δεν είναι λυμένη.
