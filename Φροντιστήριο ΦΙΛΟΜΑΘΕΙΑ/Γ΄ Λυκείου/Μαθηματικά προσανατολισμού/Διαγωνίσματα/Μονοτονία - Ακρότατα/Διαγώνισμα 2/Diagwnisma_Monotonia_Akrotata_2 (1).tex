...
\begin{erwthma}
\item Να μελετηθεί η $ f $ ως προς τη μονοτονία και τα ακρότατα.\monades{10}
\item Να βρεθεί το σύνολο τιμών της $ f $.\monades{7}
\item Να βρείτε το πλήθος των ριζών της εξίσωσης $ xe=x^2+1 $\monades{8}
\end{erwthma}
\item \mbox{}\\
