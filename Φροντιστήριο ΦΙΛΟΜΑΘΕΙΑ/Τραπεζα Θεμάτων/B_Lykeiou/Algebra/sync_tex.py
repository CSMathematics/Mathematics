...
def sync_files():
    final_tex_path = '/home/spyros/Μαθηματικά/Φροντιστήριο ΦΙΛΟΜΑΘΕΙΑ/Τραπεζα Θεμάτων/B_Lykeiou/Algebra/output_tex/trapeza_BL_algebra_full.tex'
    output_tex_dir = '/home/spyros/Μαθηματικά/Φροντιστήριο ΦΙΛΟΜΑΘΕΙΑ/Τραπεζα Θεμάτων/B_Lykeiou/Algebra/output_tex'
    output_sol_dir = '/home/spyros/Μαθηματικά/Φροντιστήριο ΦΙΛΟΜΑΘΕΙΑ/Τραπεζα Θεμάτων/B_Lykeiou/Algebra/output_solutions'
