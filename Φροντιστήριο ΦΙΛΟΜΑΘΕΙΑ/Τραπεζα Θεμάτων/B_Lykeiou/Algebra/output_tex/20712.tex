% ===================================================================
%  Αρχείο: 20712_tikz.tex (Fragment)
...
\begin{tikzpicture}[scale=0.5, >=latex]
    \draw[very thin, color=gray!30, minor tick num=4] (-1,-1) grid (26,5);
    ...
    % Peaks at 3, 15... (y=3)
    % Troughs at 9, 21... (y=0)
    \draw[very thick, color=blue!70!black, samples=200, smooth, domain=0:26] plot (\x, {1.5*sin(deg(pi/6 * \x)) + 1.5});
