\begin{alist}
\item Η συνάρτηση είναι της μορφής $f(x) = \rho \sigma\upsilon\nu x$, $x \in \mathbb{R}$ με $\rho = -3 < 0$, οπότε η ελάχιστη τιμή της είναι ίση με $-3$ και η μέγιστη τιμή της είναι ίση με $3$.

\item Η συνάρτηση είναι της μορφής $f(x) = \rho \sigma\upsilon\nu(\omega x)$ με $\omega = 1$. Άρα η περίοδος της συνάρτησης $f$ είναι $T = \dfrac{2\pi}{\omega} = \dfrac{2\pi}{1} = 2\pi$.

\item Το σχήμα Α) είναι η γραφική παράσταση της $f(x) = -3\sigma\upsilon\nu x, x \in \mathbb{R}$, γιατί είναι η μόνη που έχει μέγιστη τιμή $3$ για $x = \pi$ και ελάχιστη $-3$ για $x = 0$ και $x = 2\pi$.
