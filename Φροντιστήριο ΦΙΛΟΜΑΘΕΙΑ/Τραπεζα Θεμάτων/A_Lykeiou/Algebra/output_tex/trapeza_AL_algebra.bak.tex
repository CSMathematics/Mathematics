...
\begin{tcolorbox}[
    ...
    title={\sffamily\bfseries\small \faBook\ Ύλη Άσκησης},
    boxrule=0.8pt,
    arc=2mm,
    toptitle=1mm,
    bottomtitle=1mm,
...
\begin{itemize}[leftmargin=3mm, itemsep=0mm, label=\textcolor{secondarycolor}{\tiny\faCircle}]
}{
\end{itemize}
\end{tcolorbox}
\end{marginfigure}
...
\Askhsh{[12682]}
Δίνονται οι συναρτήσεις $f(x) = 1 - (x - 1)^{2}\ \ \text{και}\ \ g(x) = |x - 1| + 2,\ \ \mu\varepsilon\ \ x \in \mathbb{R}$
...
\begin{alist}
\item
  Το σύνολο Α που περιέχει ως στοιχεία τις τιμές του $\lambda \in \Omega$, αν επιπλέον γνωρίζετε ότι
...
& {Θέση\\Parking} &  Όχι +0 \euro & \SetCell[c=2]{l} Ναι: +35.000 \euro \\
\end{tblr}
\end{center}
