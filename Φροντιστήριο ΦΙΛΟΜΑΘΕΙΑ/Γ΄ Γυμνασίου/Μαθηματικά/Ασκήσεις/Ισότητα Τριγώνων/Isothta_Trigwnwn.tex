...
\begin{document}
\section*{\LARGE ΤΡΙΓΩΝΑ}
\begin{center}
{\normalsize  \bf\today}\mbox{}\\
\vspace{5mm}
\textbf{\large ΙΣΟΤΗΤΑ ΤΡΙΓΩΝΩΝ}
\end{center}
\begin{Methodos}[Ισότητα Τριγώνων]
Η πιο απλή εφαρμογή των κριτηρίων ισότητας τριγώνων είναι να εξεταστεί η ισότητα μεταξύ δύο ή περισσότερων τριγώνων. Εργαζόμαστε ως εξής :
\begin{bhma}
\item \textbf{'Ελεγχος}\\\
Ελέγχουμε την εκφώνηση της άσκησης τόσο για δοσμένες ισότητες η άλλες σχέσεις μεταξύ πλευρών ή γωνιών των τριγώνων, όσο και για σημαντικές λέξεις-έννοιες όπως ισοσκελές τρίγωνο, ισόπλευρο, κύκλος, μεσοκάθετος, διχοτόμος και άλλες βασικές έννοιες της γεωμετρίας, από τις οποίες παίρνουμε χρήσιμα συμπεράσμτα.
\item \textbf{Κριτήριο Ισότητας}\\
Αναφέρουμε τα ονόματα από τα τρίγωνα που θα συγκρίνουμε και γράφουμε τα στοιχεία της άσκησης δηλαδή ισότητες πλευρών ή γωνιών προκειμένου να σχηματιστεί ένα από τα τρία κριτήρια ισότητας τριγώνων. Είναι προτιμότερο να εξετάζουμε πρώτα για ισότητα πλευρών ώστε να αναγνωρίσουμε εύκολα ποιό κριτήριο θα σχηματιστεί.
\item \textbf{Συμπέρασμα}\\
Αφού σχηματιστεί κάποιο από τα τρία κριτήρια με τα δεδομένα της άσκησης καταλλήγουμε στο συμπέρασμα οτι τα τρίγωνα είναι μεταξύ τους ίσα.
\end{bhma}
\end{Methodos}
\Paradeigma{Ισότητα Τριγώνων}
\textbf{Στο παρακάτω σχήμα το τρίγωνο {\boldmath$ AB\varGamma $} είναι ισοσκελές (με {\boldmath$ AB=A\varGamma $}). Σχεδιάζουμε τις διχοτόμους {\boldmath$B\varDelta$} και {\boldmath$ \varGamma E $} των γωνιών {\boldmath$ \hat{B} $} και {\boldmath$ \hat{\varGamma} $}. Να αποδειχθεί οτι τα τρίγωνα {\boldmath$ AB\varDelta $} και {\boldmath$ A\varGamma E $} είναι μεταξύ τους ίσα.}
\begin{center}
\begin{tikzpicture}
\tkzDefPoint(-1.5,2){A}
...
\tkzMarkAngle[mark=|,size=4mm,mksize=.5mm](C,B,D)
\tkzMarkAngle[mark=|,size=4.5mm,mksize=.5mm](D,B,A)
\tkzMarkAngle[mark=|,size=4mm,mksize=.5mm](E,C,B)
\tkzMarkAngle[mark=|,size=4.5mm,mksize=.5mm](A,C,E)
\tkzDrawSegment(B,D)
\tkzDrawSegment(C,E)
