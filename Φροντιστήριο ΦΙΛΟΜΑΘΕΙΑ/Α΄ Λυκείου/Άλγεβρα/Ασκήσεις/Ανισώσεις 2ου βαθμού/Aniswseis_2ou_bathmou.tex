...
\end{alist}
\end{multicols}
\askhsh Να παραγοντοποιηθούν οι παρακάτω παραστάσεις.
\begin{multicols}{2}
\begin{alist}
\item $ 3x^2-12x+12 $
\item $ -2x^2+10x-12 $
...
\end{alist}
\end{multicols}
\askhsh Να εκτελεστούν οι πράξεις και να απλοποιηθούν τα αποτελέσματα.
\begin{multicols}{2}
\begin{alist}
\item $ \dfrac{x^2-5x+6}{x^2-4} $
\item $ \dfrac{x^2-4x+3}{x^2-1} \cdot \dfrac{x^2+x}{x-3} $
\end{alist}
\end{multicols}
...
\end{alist}
\askhsh Να βρεθεί το πεδίο ορισμού των παρακάτω συναρτήσεων.
\begin{multicols}{2}
\begin{alist}
\item $ f(x)=\sqrt{x^2-6x+8} $
\item $ f(x)=\sqrt{-x^2+3x+4} $
\item $ f(x)=\sqrt{(x-1)(x-2)} $
\item $ f(x)=\dfrac{1}{\sqrt{x^2-2x+1}} $
\end{alist}
\end{multicols}
...
\end{rlist}
\end{alist}
\askhsh Να βρεθούν οι τιμές του $\lambda\in\mathbb{R}$ ώστε η ανίσωση $ x^2+ (\lambda-1)x + 4 > 0 $ να αληθεύει για κάθε $ x\in\mathbb{R} $.\\\\
\askhsh Δίνεται η συνάρτηση $ f(x) = (\lambda-1)x^2 - 2\lambda x + \lambda + 2 $. Να βρεθούν οι τιμές του $\lambda$ ώστε $f(x) < 0$ για κάθε $x\in\mathbb{R}$.
