...
\clearpage
\titlos{ΜΑΘΗΜΑΤΙΚΑ ΠΡΟΣΑΝΑΤΟΛΙΣΜΟΥ ΘΕΤΙΚΩΝ ΣΠΟΥΔΩΝ}{Β Λυκείου}{Ορισμοί και θεωρήματα}
\vspace{1cm}
\begin{center}
\begin{tikzpicture}
...
\begin{minipage}{7cm}
\begin{center}
ΑΝΑΛΥΤΙΚΟ ΤΥΠΟΛΟΓΙΟ ΓΙΑ ΤΗ ΘΕΩΡΙΑ ΤΩΝ ΜΑΘΗΜΑΤΙΚΩΝ ΠΡΟΣΑΝΑΤΟΛΙΣΜΟΥ Β΄ ΛΥΚΕΙΟΥ
\end{center}
\end{minipage}
\end{center}
...
\textit{Ξυνόν γαρ αρχή και πέρας επί κύκλου περιφερείας.}\\\\
\textquotedblleft Σε έναν κύκλο, κάθε σημείο είναι και αρχή και τέλος.\textquotedblright\\
...
\begin{center}
\begin{tikzpicture}
\dianysma[color=\xrwma]{0,0}{2.7,.5}{E}{Z}
...
\begin{center}
\begin{tikzpicture}
\dianysma[color=\xrwma]{0,0}{3.4,1.5}{E}{Z}
...
\dianysma[color=\xrwma]{6,1.5}{7.4,0}{O}{P}
...
\wrapr{-4mm}{2}{2.7cm}{-5mm}{\begin{tikzpicture}
\dianysma{0,0}{2,1}{O}{A}
...
\item Το σημείο $ O $ είναι αρχή όλων των διανυσματικών ακτίνων του ίδιου επιπέδου ή χώρου και η επιλογή του είναι αυθαίρετη.
\end{itemize}}\mbox{}\\\\\\
...
\wrapr{-4mm}{7}{3.5cm}{-8mm}{\begin{tikzpicture}
...
\[ \overrightarrow{AB}=\overrightarrow{OB}-\overrightarrow{OA} \]}\mbox{}\\\\\\
\newpage\noindent
...
\wrapr{-5mm}{8}{4.5cm}{-4mm}{\begin{tikzpicture}
...
\item Αν $ M_1(x,y) $ είναι ένα σημείο της παραβολής τότε και το σημείο $ M_2(-x,y) $ θα είναι επίσης σημείο της παραβολής.
\end{rlist}
