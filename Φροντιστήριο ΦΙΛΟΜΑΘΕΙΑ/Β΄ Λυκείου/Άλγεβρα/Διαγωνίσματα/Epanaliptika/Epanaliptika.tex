...
\foreach \z in {1,...,7}{
\thispagestyle{empty}
\titlos{Άλγεβρα Β΄ Λυκείου}{Συστήματα}
\noindent
Κωδικός διαγωνίσματος : $ A\t B\x \varGamma\y\varDelta\z $
\begin{thema}
\item\input{1o_Thema/1_\t.tex}
\item\input{2o_Thema/2_\x.tex}
\item\input{3o_Thema/3_\y.tex}
\item\input{4o_Thema/4_\z.tex}
\end{thema}
\newpage}}}}
\end{document}