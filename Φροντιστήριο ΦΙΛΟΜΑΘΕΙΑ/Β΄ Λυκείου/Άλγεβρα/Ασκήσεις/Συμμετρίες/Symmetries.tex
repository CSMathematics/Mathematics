...
\twocolumn[{
\centering
\kerkissans{{\huge Συμμετρίες συναρτήσεων}\\\vspace{3mm} {\Large ΑΣΚΗΣΕΙΣ}}\vspace{5mm}}]
...
\askhsh Δίνεται η συνάρτηση $f(x)=x^2+(\lambda-1)x+4$.
\begin{alist}
    \item Να βρείτε το πεδίο ορισμού της $f$.
    \item Να βρείτε την τιμή του $\lambda$ ώστε η $f$ να είναι άρτια.
    \item Για την τιμή του $\lambda$ που βρήκατε, να βρείτε την ελάχιστη τιμή της $f$.
\end{alist}
\askhsh Δίνεται η συνάρτηση $f(x)=\lambda x^3+x$.
\begin{alist}
    \item Να δείξετε ότι η $f$ είναι περιττή για κάθε τιμή του $\lambda$.
    \item Να βρείτε το $\lambda$ αν $f(1)=3$.
    \item Για $\lambda=2$, να εξετάσετε αν η $f$ είναι γνησίως αύξουσα στο $\mathbb{R}$.
\end{alist}
