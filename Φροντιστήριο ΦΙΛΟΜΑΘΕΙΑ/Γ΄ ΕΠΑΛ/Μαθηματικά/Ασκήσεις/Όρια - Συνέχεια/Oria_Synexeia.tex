...
\vspace{10mm}\mbox{}\\
\centering
\kerkissans{{\huge Μαθηματικά - Γ' ΕΠΑ.Λ.}\\\vspace{2mm} {\LARGE Όρια - Συνέχεια}}\\\vspace{4mm}{\kerkissans{\today}}}]
\paragraph{Όρια $\frac{0}{0}$ - Ρητή συνάρτηση}
\askhsh Να υπολογίσετε τα παρακάτω όρια.
\begin{alist}
\begin{multicols}{2}
\item $\lim\limits_{x\to 2}{\dfrac{x^2-4}{x-2}}$
\item $\lim\limits_{x\to 3}{\dfrac{x^2-3x}{x^2-9}}$
\item $\lim\limits_{x\to 1}{\dfrac{x-1}{x^2-x}}$
\item $\lim\limits_{x\to -3}{\dfrac{x^2+4x+3}{x^2+3x}}$
\item $\lim\limits_{x\to -1}{\dfrac{x^3+x^2}{x^2-x-2}}$
\item $\lim\limits_{x\to 4}{\dfrac{x^2+2x-8}{x^3-4x^2}}$
\end{multicols}
\item $\lim\limits_{x\to -2}{\dfrac{x^3-4x}{x^3-x+6}}$
\item $\lim\limits_{x\to 2}{\dfrac{x^3-3x^2+4x-12}{x^3-7x+6}}$
\end{alist}
\paragraph{Όρια $\frac{0}{0}$ - Άρρητη συνάρτηση}
\askhsh Να υπολογίσετε τα παρακάτω όρια.
\begin{alist}
\begin{multicols}{2}
\item $\lim\limits_{x\to 1}{\dfrac{x-1}{\sqrt{x}-1}}$
\item $\lim\limits_{x\to 2}{\dfrac{\sqrt{2x}-2}{x^2-4}}$
\item $\lim\limits_{x\to 1}{\dfrac{\sqrt{x+3}-2}{x^2+x-2}}$
\item $\lim\limits_{x\to 5}{\dfrac{x^2-5x}{\sqrt{x+4}-3}}$
\item $\lim\limits_{x\to -2}{\dfrac{\sqrt{x+3}-1}{\sqrt{2-x}-2}}$
\item $\lim\limits_{x\to 3}{\dfrac{\sqrt{x+1}-\sqrt{7-x}}{x^2-9}}$
\end{multicols}
\item $\lim\limits_{x\to -1}{\dfrac{\sqrt{1-3x}-\sqrt{5+x}}{x^2-1}}$
\item $\lim\limits_{x\to 2}{\dfrac{x-2}{\sqrt{x-2}}}$
\end{alist}
\askhsh 
\end{document}
