...
\begin{document}
\titlos{Μαθηματικά Α΄ Γυμνασίου}{Εμβαδά}{Μονάδες Μέτρησης Επιφάνειας}
\askhseis
\begin{enumerate}
\item Να μετατρέψεις τα παρακάτω μεγέθη σε τετραγωνικά μέτρα ($ m^2 $).
\begin{multicols}{2}
\begin{rlist}
\item $ 3{,}75 $ στρέμματα
\item $ 550\ dm^2 $
...
\end{rlist}
\end{multicols}
\item Να μετατρέψεις τα παρακάτω μεγέθη σε τετραγωνικά εκατοστά ($ cm^2 $).
\begin{multicols}{2}
\begin{rlist}
\item $ 45{,}7\ m^2 $
\item $ 300\ dm^2 $
...
\end{rlist}
\end{multicols}
\item Να μετατρέψεις τα παρακάτω μεγέθη στην ίδια μονάδα μέτρησης και στη συνέχεια να τα τοποθετήσεις στη σειρά από το μεγαλύτερο στο μικρότερο.
\[ 39\ dm^2\ ,\ 250.000\ mm^2\ ,\ 0{,}4\ m^2\ ,\ 7.000\ cm^2\ ,\ 0{,}0000005\ km^2 \]
\end{enumerate}
\end{document}
